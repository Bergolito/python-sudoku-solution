...
if __name__ == '__main__':
    p1 = Posicao_Possibilidades(0, 2, [3, 4, 5, 8])
    p2 = Posicao_Possibilidades(1, 3, [1, 5, 8, 9])
    p3 = Posicao_Possibilidades(3, 6, [3, 5, 6, 7])
    lista_possibilidades = [p1, p2, p3]
    imprime_trincas(lista_possibilidades)
    arvore = monta_arvore_04_possibilidades(lista_possibilidades)
