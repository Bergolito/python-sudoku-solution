...
# ====================================
def monta_arvore_06_possibilidades(lista_possibilidades):
    lista_global = [[], [], [], [], [], []]
    ...
    for k, pp in enumerate(lista_possibilidades):
        if k == 0:
            ...
            lista_global = sextuplica_lista_trincas(lista_global, lista_trincas_arg)
...
'''
def sextuplica_lista_trincas(lista_global, nova_lista_trincas):
    ...
    if len(lista_global) == 0:
        ...
        nova_lista_retornada = [[] for i in range(6 * len(lista_global))]
...
if __name__ == '__main__':
    p1 = Posicao_Possibilidades(0, 2, [1, 2, 3, 4, 5, 8])
    p2 = Posicao_Possibilidades(1, 3, [1, 3, 5, 5, 8, 9])
    p3 = Posicao_Possibilidades(3, 6, [3, 4, 6, 5, 6, 7])
    lista_possibilidades = [p1, p2, p3]
    imprime_trincas(lista_possibilidades)
    arvore = monta_arvore_06_possibilidades(lista_possibilidades)
